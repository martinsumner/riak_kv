...
- `leveled.compression_method`; should be set to `zstd` {: .d-inline-block } Available from Riak 3.2.1 {: .label .label-green }, unless objects are sent to Riak compressed, in which case the compression method should be configured as `none`.
